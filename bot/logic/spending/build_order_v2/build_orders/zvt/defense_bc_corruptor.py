...
build = {
    ...
    'buildings' : [
        ...
        [UnitTypeId.SPIRE, 55, 55, (UnitTypeId.LAIR,), 1],
    ...
    'units' : [
        ...
        [UnitTypeId.CORRUPTOR, 55, 4, (UnitTypeId.SPIRE,)],
...
comp = [
    {   UnitTypeId.DRONE : None,
        ...
        UnitTypeId.BATTLECRUISER : (UnitTypeId.CORRUPTOR, UnitTypeId.HYDRALISK, UnitTypeId.QUEEN),
